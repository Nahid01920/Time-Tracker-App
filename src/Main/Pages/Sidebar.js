...
//       } lg:translate-x-0 lg:relative lg:w-64 lg:h-auto lg:bg-gray-800`}
//     >
...
//       </div>
//       <nav className="mt-10">
//         <Link to="/" className="block py-2 px-4 hover:bg-gray-700" onClick={toggleSidebar}>
//           Dashboard
//         </Link>
//         {!isAuth ? (
//           <Link to="/login" className="block py-2 px-4 hover:bg-gray-700" onClick={toggleSidebar}>
//             Login
//           </Link>
//         ) : (
//           <>
//             <Link to="/AddTask" className="block py-2 px-4 hover:bg-gray-700" onClick={toggleSidebar}>
//               Add Task
//             </Link>
//             <button
//               onClick={() => {
