              ...
              <button onClick={toggleSidebar} className="lg:hidden p-2 ">
                {showSidebar ? (
                  <img
                    src={closeIcon}
                    alt="Close Sidebar"
                    className="w-6 h-6 closeBtn absolute ml-[-38px] rounded-full z-50 bg-white p-1"
                  />
                ) : (
                  <img
                    src={openIcon}
                    alt="Open Sidebar"
                    className="w-6 h-6 openBtn absolute z-50 bg-white pl-1 pt-1 rounded-full mt-5"
                  />
                )}
              </button>
            )}
